...
export default function UsuariosPage() {
  ...
  const loadData = async () => {
    try {
      setLoading(true)
      const [usuariosData, centrosData, medicosData] = await Promise.all([
      ...
      <div className={`fixed inset-y-0 left-0 z-50 w-64 bg-blue-900 transform ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'} transition-transform duration-300 ease-in-out lg:translate-x-0`}>
        ...
        <nav className="mt-8">
          <div className="px-4 space-y-2">
            ...
            <a href="/usuarios" className="w-full flex items-center px-4 py-2 text-white bg-blue-800 rounded-lg">
