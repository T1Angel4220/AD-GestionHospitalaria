-- Script para inicializar base de datos Central (Quito)
...
VALUES ('admin@hospital.com', '$2a$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'admin', 1);
...
-- Insertar centro central
INSERT IGNORE INTO centros_medicos (id, nombre, ciudad, direccion, telefono) 
VALUES (1, 'Hospital Central Quito', 'Quito', 'Av. 6 de Diciembre', '02-2222-2222');
...
('Medicina General', 'Atención médica general', 1),
('Cardiología', 'Especialidad en enfermedades del corazón', 1),
('Pediatría', 'Especialidad en medicina infantil', 1);
...
VALUES ('Dr. Juan', 'Pérez', '1234567890', '0987654321', 'juan.perez@hospital.com', 1, 1);
...
VALUES ('María', 'González', '0987654321', '0998765432', 'maria.gonzalez@email.com', '1990-05-15', 'F', 1);
...
VALUES ('2024-01-15 10:00:00', 'Dolor de cabeza', 'Migraña', 'Reposo y medicamento', 'completada', 1, 1, 1);
...
('Ana', 'Rodríguez', '1111111111', '0991111111', 'ana.rodriguez@hospital.com', 'Enfermera Jefe', 1200.00, '2023-01-15', 1),
('Carlos', 'Mendoza', '2222222222', '0992222222', 'carlos.mendoza@hospital.com', 'Técnico de Laboratorio', 800.00, '2023-02-20', 1),
('Laura', 'Vega', '3333333333', '0993333333', 'laura.vega@hospital.com', 'Recepcionista', 600.00, '2023-03-10', 1);