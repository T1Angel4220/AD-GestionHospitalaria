...
async function debugFrontendRealProblema() {
  console.log('🔍 DEBUGGING FRONTEND REAL PROBLEMA');
  console.log('====================================\n');
  ...
  try {
    ...
    const formData = {
      ...
      motivo: 'debug frontend real problema',
      diagnostico: 'debug frontend real problema',
      tratamiento: 'debug frontend real problema',
      estado: 'pendiente',
      duracion_minutos: 0
    };
